...
const DesignToConstructionVisualizer = () => {
  return (
    <div className="flex  items-start flex-wrap  md:flex-row md:items-center gap-[1em]">
      {/* design */}
      <div className=" flex    items-center gap-[1em]">
        <h1 className="hidden md:block text-primary_color_light">
          Your Design
        </h1>
        <h3 className=" md:hidden block text-primary_color_light">
          Your Design
        </h3>
      ...
      {/* Experts */}
      <h1 className='hidden md:block text-primary_color_light'>Experts </h1>
      <h3 className=' md:hidden block text-primary_color_light'>Experts</h3>
