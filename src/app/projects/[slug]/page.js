...
<>
    ...
    {project == null ?       <div className="w-full bg-primary_color h-[100dvh]"> Content Loading</div> : ""}
      ...
      <div className='w-full z-[11] shadow-lg  md:block md:w-[30%] p-10 md:h-[100vh] flex-col items-start bg-primary_color sticky top-0 md:top-[50px]'>
           <div>
           <h4 className='text-text_color  font-primary_font_bold'>{project.projectName}</h4>
            ...
            <br/>
            <p className='text-text_color font-thin'> <strong>Start Date : </strong> <br/> {project?.startDate}</p>
            <p className='text-text_color font-thin'> <strong>End Date :</strong><br/>  {project?.endDate}</p>
            <br/>
...
<p className='text-text_color '> <strong>Start Date : </strong> <br/> {project?.startDate}</p>
<p className='text-text_color '> <strong>End Date :</strong><br/>  {project?.endDate}</p>
...
<div>
<h4 className="text-text_color font-primary_font_bold">Intro:</h4>
<p className="text-text_color ">{project?.projectExcerpt}</p>
</div>

<div className="bg-primary_color border border-2 border-tertiary_color shadow-md p-4 md:p-10">
<h5 className="  text-primary_color_light font-primary_font_bold">Target:</h5> 
...
<div>
       ...
       <div className="rich-text">
        <h4 className="text-text_color  font-primary_font_bold">Details:</h4>
   ...
   <RichText className="rich-text " content={project.projectDetails.raw}></RichText>  
          ...
          {/* Meet Our Team*/}
     <div  >
            <h4 className="font-primary_font_bold text-text_color ">Gallery  Media Of Our Project</h4>
          <br/>
